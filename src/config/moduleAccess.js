...
const ROUTE_MODULE_RULES = [
  ...
  { test: (path) => path.startsWith('/sales-flow') || path === '/clients' || path === '/prospects-clients' || path === '/client-orders' || path === '/po-ingestion' || path === '/client-dashboard' || path === '/products' || path === '/product-master', moduleKey: MODULE_KEYS.SALES },
