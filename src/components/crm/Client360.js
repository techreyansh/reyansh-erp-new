...
export default function Client360({ account, onClose, notify }) {
  ...
  const TABS = ['Overview', 'Contacts', 'Products', 'Quotations', 'Sales Orders', 'Production', 'Dispatch', 'Invoices', 'Payments', 'Timeline', 'KIT', 'Tasks', 'Documents', 'Complaints', 'AI Copilot'];
