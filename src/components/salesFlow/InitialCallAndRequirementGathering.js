                  ...
                  <Box display="flex" alignItems="center" gap={3}>
                    ...
                    <Box display="flex" alignItems="center" gap={2}>
                      <Box sx={(theme) => ({
                        ...
                        <Call sx={{ fontSize: 28, color: 'common.white' }} />
                      </Box>
                      <Box>
                    ...
                    <Table>
                      <TableHead>
                        <TableRow sx={(theme) => ({ background: `linear-gradient(135deg, ${theme.palette.primary.dark} 0%, ${theme.palette.primary.main} 100%)` })}>
                          ...
                          <TableCell sx={{ color: 'common.white', fontWeight: 600 }}>Location</TableCell>
                          <TableCell sx={{ color: 'common.white', fontWeight: 600 }}>Customer Type</TableCell>
