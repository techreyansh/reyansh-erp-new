...
const ApproveStrategicDeals = () => {
  ...
  const [strategicDealApprovalStatus, setStrategicDealApprovalStatus] = useState('Approved');
  const [strategicDealNotes, setStrategicDealNotes] = useState('');
  ...
  const loadLeadsForStep10 = async () => {
    try {
      setLoading(true);
      const leadsData = await salesFlowService.getStrategicDealApprovalDetails();
      setLeads(leadsData);
    } catch (error) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const approvalData = {
        ...
        SampleApprovalStatus: selectedLead.SampleApprovalStatus,
        SampleApprovalNotes: selectedLead.SampleApprovalNotes,
        StrategicDealApprovalStatus: strategicDealApprovalStatus,
        StrategicDealNotes: strategicDealNotes,
        ApprovedBy: user?.email || user?.name,
        Status: 'Completed'
      };

      await salesFlowService.saveStrategicDealApproval(approvalData);
      
      setSnackbar({
        open: true,
        message: `Strategic Deal ${strategicDealApprovalStatus.toLowerCase()} successfully`,
        severity: 'success'
      });

      // Reset form
      setSelectedLead(null);
      setStrategicDealApprovalStatus('Approved');
      setStrategicDealNotes('');
      
      // Reload leads
      await loadLeadsForStep10();
                ...
                <Box display="flex" alignItems="center" gap={2} mb={2}>
                  ...
                  <Box>
                    ...
                    <Typography variant="h6" sx={{ 
                      ...
                      Review and approve/reject strategic deals with sample approval details
                    </Typography>
                  </Box>
                </Box>
              </CardContent>
                    ...
                    <Table>
                      <TableHead>
                        <TableRow sx={(theme) => ({
                          ...
                          <TableCell sx={{ color: 'common.white', fontWeight: 700 }}>Sample Status</TableCell>
                            ...
                            <TableCell colSpan={7} align="center" sx={{ py: 8 }}>
                              <Box display="flex" flexDirection="column" alignItems="center" gap={2}>
                                ...
                                <Typography variant="h6" color="textSecondary" sx={{ fontWeight: 500 }}>
                                  No strategic deals pending approval
                                </Typography>
                                <Typography variant="body2" color="textSecondary">
                                  All strategic deals have been reviewed or no deals are ready for approval
                                </Typography>
                              </Box>
                            </TableCell>
                          </TableRow>
                          ...
                          leads.map((lead, index) => (
                            <Fade in timeout={300 + index * 100} key={lead.LogId}>
                              ...
                              >
                                ...
                                <TableCell>
                                  <Chip 
                                    label={lead.SampleApprovalStatus || 'N/A'} 
                                    size="small" 
                                    color={getStatusColor(lead.SampleApprovalStatus)}
                                    sx={{ fontWeight: 600 }}
                                  />
                                </TableCell>
                                <TableCell>
              ...
              <Card sx={(theme) => ({
                ...
                <CardContent sx={{ p: 4 }}>
                  ...
                  <Grid container spacing={3}>
                      ...
                      <Box display="flex" flexDirection="column" gap={2}>
                        ...
                        <Box display="flex" alignItems="center" gap={2}>
                          ...
                          <Box>
                            ...
                            <Typography variant="caption" color="textSecondary">
                              ID: {selectedLead.QuotationDocumentId || 'N/A'}
                            </Typography>
                          </Box>
                        </Box>
                        ...
                        <Box display="flex" alignItems="center" gap={2}>
                          ...
                          <Box>
                            <Typography variant="body2" sx={{ fontWeight: 600 }}>
                              Sample: {selectedLead.SampleApprovalStatus || 'N/A'}
                            </Typography>
                            <Typography variant="caption" color="textSecondary">
                              {formatDate(selectedLead.SampleApprovedAt)}
                            </Typography>
                          </Box>
                        </Box>
                      </Box>
                    ...
                    <Grid item xs={12} md={6}>
                      <Typography variant="h6" sx={{ mb: 2, color: 'text.primary' }}>
                        Strategic Deal Decision
                      </Typography>
                      
                      <FormControl fullWidth sx={{ mb: 3 }}>
                        <InputLabel>Strategic Deal Approval Status</InputLabel>
                        <Select
                          value={strategicDealApprovalStatus}
                          onChange={(e) => setStrategicDealApprovalStatus(e.target.value)}
                          label="Strategic Deal Approval Status"
                          sx={{ borderRadius: 2 }}
                        >
                      ...
                      <TextField
                        ...
                        value={strategicDealNotes}
                        onChange={(e) => setStrategicDealNotes(e.target.value)}
                        placeholder="Provide detailed notes about your strategic deal approval decision..."
                        sx={{ borderRadius: 2 }}
                      />
                    </Grid>
                  </Grid>
                    ...
                    <Box display="flex" justifyContent="space-between" alignItems="center">
                      ...
                      <Box display="flex" gap={2}>
                        ...
                        <Button
                          ...
                          disabled={loading || !strategicDealNotes.trim()}
                          sx={(theme) => ({
                            background: strategicDealApprovalStatus === 'Approved'
                            ...
                            py: 1.5,
                            borderRadius: 2,
                            boxShadow: strategicDealApprovalStatus === 'Approved'
                        ...
                        >
                          {loading ? 'Processing...' : `${strategicDealApprovalStatus} Strategic Deal`}
                        </Button>
                      </Box>
                    </Box>
                  </Grid>
...
export default ApproveStrategicDeals;
