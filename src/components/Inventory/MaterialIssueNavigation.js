...
import MaterialIssueRegister from "../MaterialIssue/MaterialIssueRegister";
import { useAuth } from "../../context/AuthContext";
import { useNavigate } from "react-router-dom";

const MaterialIssueNavigation = () => {
        ...
        return (
          <Card sx={{ p: 4, textAlign: 'center' }}>
            <Typography variant="h6" color="text.secondary">
              Issue Reports - Coming Soon
            </Typography>
            <Typography variant="body2" sx={{ mt: 2 }}>
              Detailed reports and analytics for material issues will be available here.
            </Typography>
          </Card>
        );
      case 2:
        return (
          <Card sx={{ p: 4, textAlign: 'center' }}>
            <Typography variant="h6" color="text.secondary">
              Issue History - Coming Soon
            </Typography>
            <Typography variant="body2" sx={{ mt: 2 }}>
              Historical data and trends for material issues will be available here.
            </Typography>
          </Card>
        );
      default:
            ...
            >
              ...
              <Stack direction="row" alignItems="center" spacing={3} sx={{ order: { xs: 1, md: 2 } }}>
                ...
                <Box>
                  ...
                  >
                    Monitor material consumption and outgoing
                  </Typography>
                </Box>
              </Stack>
...
export default MaterialIssueNavigation;
