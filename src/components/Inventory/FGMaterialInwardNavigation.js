...
import FGMaterialInward from "./FGMaterialInward";
import { useAuth } from "../../context/AuthContext";
import { useNavigate } from "react-router-dom";

const FGMaterialInwardNavigation = () => {
  ...
  const renderTabContent = () => {
    switch (selectedTab) {
      case 0:
        return <FGMaterialInward />;
      case 1:
        return (
          <Card sx={{ p: 4, textAlign: 'center' }}>
            <Typography variant="h6" color="text.secondary">
              FG Inward Reports - Coming Soon
            </Typography>
            <Typography variant="body2" sx={{ mt: 2 }}>
              Detailed reports and analytics for FG material inward will be available here.
            </Typography>
          </Card>
        );
      case 2:
        return (
          <Card sx={{ p: 4, textAlign: 'center' }}>
            <Typography variant="h6" color="text.secondary">
              FG Inward History - Coming Soon
            </Typography>
            <Typography variant="body2" sx={{ mt: 2 }}>
              Historical data and trends for FG material inward will be available here.
            </Typography>
          </Card>
        );
      default:
            ...
            >
              ...
              <Stack direction="row" alignItems="center" spacing={3} sx={{ order: { xs: 1, md: 2 } }}>
                ...
                <Box>
                  ...
                  >
                    Track incoming finished goods materials
                  </Typography>
                </Box>
              </Stack>

              <Tooltip title="Next to FG Material Outward">
                <IconButton
...
export default FGMaterialInwardNavigation;
